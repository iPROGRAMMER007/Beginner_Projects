...
def play_game():
    ...
    if winner == "X" or winner == "O":
        print(winner + ': wins')
        speak(winner + ': wins')
        speak("Press y/Y to continue | Press n/N to quit : ")
        continue_game = input("Press y/Y to continue | Press n/N to quit : ")
...
def handle_turn(player):
    ...
    while not valid:
        while position not in ['1', '2', '3', '4', '5', '6', '7', '8', '9']:
            speak('Invalid position. Please select a valid from 1-9 : ')
        ...
        if board[position] == '_':
            ...
            speak("You can't put here go to other part")
...
def select_player():
    ...
    valid_player = False
    speak('Tic tac toe game is going to start')
    while not valid_player:
        ...
        if select_symbol == 'X' or select_symbol == 'O':
            ...
            current_player = select_symbol
            print('You are : ' + select_symbol)
            speak('You are : ' + select_symbol)
            valid_player = True
        else:
            print("Wrong symbol please select right symbol. ")
            speak("Wrong symbol please select right symbol. ")
            valid_player = False
